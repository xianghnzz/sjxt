...
<style scoped>
	...
	.tui-btn-primary-gradient {
		background-image: linear-gradient(to right, #FB7A78, #F54F4C) !important;
		color: #fff;
	}
	...
	.tui-shadow-primary-gradient {
		box-shadow: 0 10rpx 14rpx 0 rgba(245, 79, 76, 0.38);
	}
	...
	.tui-primary-outline {
		...
		/* #ifdef MP-QQ */
		border: 1rpx solid var(--color-primary) !important;
		/* #endif */
	}
