@font-face {font-family: "van-icon";
  src: url('/src/style/iconfont/iconfont.eot?t=1587110571737'); /* IE9 */
  src: url('/src/style/iconfont/iconfont.eot?t=1587110571737#iefix') format('embedded-opentype'), /* IE6-IE8 */
  ...
  url('/src/style/iconfont/iconfont.ttf?t=1587110571737') format('truetype'), /* chrome, firefox, opera, Safari, Android, iOS 4.2+ */
  url('/src/style/iconfont/iconfont.svg?t=1587110571737#van-icon') format('svg'); /* iOS 4.1- */
}
