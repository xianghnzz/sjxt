<template>
	<view class="image-cropper" @wheel="cropper.mousewheel">
		...
		<view class="pic-preview" :change:init="cropper.initObserver" :init="initData" @touchstart="cropper.touchstart"
			@touchmove="cropper.touchmove" @touchend="cropper.touchend">
